...
(* OASIS_START *)
(* DO NOT EDIT (digest: ebf872a950df5fdbbaffeff47c5fea52) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_hc", ["-q"]))];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Huffman_code"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "huffman-code";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "(\137¾z]\006Ù~ÏD\144Ðî÷ÕV";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
